...
{
	// 1. Determine recursivamente si un número dado es par o impar, usando sólo la operación resta. 
	...
	// 3. Suma de los dígitos de un número: Escribe un método recursivo que calcule la suma de los dígitos de un número entero. 
	// El método debe aceptar un solo parámetro: el número entero del cual se calculará la suma de los dígitos. 
	...
	// 4. Impresión de una cadena en orden inverso: Escribe un método recursivo que imprima una cadena dada en orden inverso. 
	// El método debe aceptar un solo parámetro: la cadena que se imprimirá en orden inverso. Por ejemplo, si la cadena es "Hola", 
	...
	// El factorial de un número n se denota como n! y se define como el producto de todos los enteros positivos desde 1 hasta n. 
	...
	// 6. Cálculo de la suma de los primeros n números naturales: Escribe un método recursivo que calcule la suma de los 
	...
	// 7. Impresión de números naturales en orden ascendente: Escribe un método recursivo que imprima todos los números 
	// naturales desde 1 hasta n en orden ascendente. Por ejemplo, printNumbers(5) debería imprimir "1 2 3 4 5". 
	...
	// 8. Cálculo de la suma de los dígitos de un número binario: Escribe un método recursivo que calcule la suma de los 
	// dígitos de un número binario. El método debe aceptar un solo parámetro: el número binario como una cadena de dígitos (0 o 1). 
	...
	// 9. Generación de todas las permutaciones de una cadena: Escribe un método recursivo que genere todas las 
	// permutaciones de los caracteres de una cadena dada. Por ejemplo, las permutaciones de la cadena 
	// "abc" son "abc", "acb", "bac", "bca", "cab" y "cba". El método debe aceptar la cadena original y una cadena parcial 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Par o impar de 4: " + fr.parImparBooleano(4));  // Debería imprimir true
        System.out.println("Par o impar de 7: " + fr.parImparBooleano(7));  // Debería imprimir false
        ...
        System.out.println("\n6. Suma de números");
        System.out.println("Suma de los primeros 5 números naturales: " + fr.sumaNumeros(5));  // Debería imprimir 15 (1+2+3+4+5)
        ...
        System.out.println("Suma de los dígitos binarios de '1011': " + fr.sumaDigitosBinarios("1011"));  // Debería imprimir 3
